...
const PROJECTS = [
  {
    ...
    title:       'AtmosPal',
    description: 'A real-time weather dashboard with current conditions and a 5-day forecast for any city worldwide. Features clean search UI, live API data, and a fully responsive layout.',
  ...
  },
  {
    ...
    title:       'Taskflow',
    description: 'A smart task manager with reminders and real-time sync. Clean notepad-style UI backed by Supabase for persistent data storage across devices.',
    ...
    <section id="projects" className="section">
      <div className="container">
        ...
        <div style={{ textAlign: 'center', marginTop: 44 }}>
          ...
          <a href="https://github.com/Eritofunmi01" target="_blank" rel="noreferrer"
...
function ProjectCard({ project: p }) {
  return (
    ...
    >
      ...
      {/* Description */}
      <p style={{ color: 'var(--muted)', fontSize: '0.93rem', lineHeight: 1.7, flex: 1 }}>
        {p.description}
      </p>
