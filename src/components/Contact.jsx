...
// ─── EmailJS credentials — update these in your .env or directly here ─────────
...
// ─── Social links — edit href values here ─────────────────────────────────────
const SOCIALS = [
    ...
    <section id="contact" className="relative">
      <div className="section-wrap">
        ...
        <Reveal>
          ...
          <p className="text-dim leading-relaxed max-w-[500px] mb-14" style={{ fontSize: '0.97rem' }}>
            Have a project in mind? Want to collaborate or just say hi?
            I'm always open to the right opportunity — drop me a message.
          </p>
        </Reveal>
            ...
            <div className="glass-card p-7 md:p-10">
              ...
              <AnimatePresence>
                {sent && (
                  ...
                  >
                    <div className="flex items-center gap-3 p-4 rounded-xl font-mono text-[0.82rem]"
                      style={{ background: 'rgba(0,255,178,0.07)', border: '1px solid rgba(0,255,178,0.25)', color: 'var(--mint)' }}>
              ...
              <form ref={form} onSubmit={sendEmail} className="flex flex-col gap-5">
                ...
                >
                  {loading ? (
                    <>
                      <span className="w-3.5 h-3.5 rounded-full border-2 border-void/30 border-t-void inline-block animate-spin" />
                      Sending…
                    </>
                  ) : (
                    <>
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  {SOCIALS.map((s, i) => (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex items-center gap-2.5 px-3.5 py-3 rounded-xl border border-mint/10
                                 bg-white/[0.015] text-dim font-mono text-[0.72rem] no-underline
