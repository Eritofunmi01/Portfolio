    ...
    <section id="contact" className="section" style={{ background: 'var(--bg2)' }}>
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, alignItems: 'start' }}
          ...
          {/* ── Form ── */}
          <div className="card">
            <h3 style={{ fontWeight: 700, fontSize: '1.1rem', marginBottom: 24, color: 'var(--text)' }}>
              Send me a message
            </h3>
            ...
            <form ref={form} onSubmit={send} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div>
                ...
                <input name="subject" type="text" required placeholder="Project discussion, collaboration, etc." className="field" />
              </div>
              <div>
                  ...
                  <div key={item.label} style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                    ...
                    <div>
                      <p style={{ fontSize: '0.72rem', color: 'var(--muted)', fontWeight: 600,
                        textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 2 }}>{item.label}</p>
                      <p style={{ color: 'var(--text)', fontSize: '0.92rem' }}>{item.value}</p>
                    </div>
                  </div>
                ))}
              </div>
