        ...
        <div className="about-grid">
          ...
          <div>
            <p data-anim style={{
              ...
              fontSize: '1rem', lineHeight: 1.8, marginBottom: 18,
            }}>
              I'm <strong style={{ color: 'var(--accent)' }}>Sodiya Tofunmi</strong>, a full-stack developer
              based in Lagos, Nigeria. I started coding in early 2024 and haven't stopped since —
              building web apps, mobile apps, and everything in between.
            </p>

            <p data-anim style={{
              opacity: 0, color: 'var(--muted)',
              fontSize: '1rem', lineHeight: 1.8, marginBottom: 32,
            }}>
              I'm ambitious, self-driven, and genuinely excited by technology. Currently deepening
              my knowledge in AI &amp; Automation. Open to full-time roles and freelance work —
              I show up, I deliver, and I keep growing.
            </p>

            {/* Stats */}
            <div data-anim style={{ opacity: 0 }} className="stats-grid" style2={{ marginBottom: 28 }}>
              {STATS.map(s => (
                <div key={s.label} className="card" style={{ textAlign: 'center', padding: '18px 12px' }}>
                  <p style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--accent)', marginBottom: 4 }}>
                    {s.value}
                  </p>
            ...
            {/* Buttons */}
            <div data-anim style={{ opacity: 0, marginTop: 24 }} className="btn-row">
